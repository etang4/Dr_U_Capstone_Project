...
public class UnlockPanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Create display list
        containerRect.GetComponent<GridLayoutGroup>().cellSize = new Vector2(containerRect.GetComponent<RectTransform>().rect.width / 4,
                                                                             containerRect.GetComponent<RectTransform>().rect.width / 4);
        ...
        for (int i = 0; i < listSize; i++)
        {
            ...
            GameObject newImage = new GameObject("Unlocks " + i);
